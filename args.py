...
def parse_arguments():
    ...
    parser.add_argument(
        "--freeze-subnet",
        action="store_true",
        help="Whether or not to train only weights (this freezes subnet)",
    )
    parser.add_argument("--mode", default="fan_in", help="Weight initialization mode")
    parser.add_argument(
        "--activation", default="relu", help="Nonlinearity used by initialization"
    )
    parser.add_argument("--bn-type", default=None, help="BatchNorm type")
    parser.add_argument(
        "--init", default="HeNormal", help="Weight initialization modifications"
    )
    parser.add_argument(
